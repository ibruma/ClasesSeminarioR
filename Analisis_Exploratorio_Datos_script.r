...
stripchart(Barajas.Ene$O3,method="stack",frame=FALSE,
     xlim=c(0,60),xlab="Concentracion de Ozono",
     sub="Baraja.Enero 2019")
points(x=mean(Barajas.Ene$O3),y=0.9,pch=17,cex=1.5)
lines(x=c(0,60),y=c(0.97,0.97))
...
stripchart(Barajas.Ene$O3,method="stack",frame=FALSE,
     xlim=c(0,60),xlab="Concentracion de Ozono",
     sub="Baraja.Enero 2019")
points(x=mean(Barajas.Ene$O3),y=0.9,pch=17,cex=1)
points(x=median(Barajas.Ene$O3),y=0.9,pch=10,cex=1.5)
lines(x=c(0,60),y=c(0.97,0.97))
...
cuart <- quantile(Barajas.Ene$O3,prob=c(0.25,0.75))
stripchart(Barajas.Ene$O3,frame=FALSE,xlab="y",method="stack")
abline(v=cuartil[1],col="red",lty=2)
abline(v=cuartil[2],col="red",lty=2)
